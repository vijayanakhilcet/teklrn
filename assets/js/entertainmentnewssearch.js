...
function refineSearchView(pg){
    ...
    var html_message ="";
    $.ajax({
        url         : "/getEntertainmentNewsMatchingTheSearch", // the url where we want to POST
