    ...
    $.ajax({
        ...
        .done(function(data) {
            ...
            $.each(data, function(index) {
                ...
                for (info in infos) {
                    html_message = html_message+'<div href="" onclick="gotoTechnology2(\''+infos[info]+'\')" class="indigo fs-s3 after-arrow-right my-4" style="text-decoration: underline;padding-left: 13px; !important; font-weight: bold;">'+infos[info]+'</div><hr>';
                }   
