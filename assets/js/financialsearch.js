    ...
    $.ajax({
        ...
        .done(function(data) {
            ...
            $.each(data, function(index) {
                ...
                html_message_marq_waterfall +='<div style="padding-bottom:130px;  height:100%;"><div style="float: right; width: 50%;"><img id="'+'marqwaterfall'+data[index].description+'" style="width:200px;height:100px;object-fit: cover;visibility:hidden; border-radius: 10px;" onerror="this.src=\'/static/image/test/certificate.jpg\'"  src="" alt="TEKLRN"/></div><div style="padding-left: 22px !important;padding-right: 12px !important;float: left; width: 50%; font-weight: 1050 !important; font-family: \'Poppins\', sans-serif; text-transform: Capitalize !important;"><a style="border-bottom-color: #507fce;text-align: -webkit-center;font-weight: 300; font-size: .7rem;font-family: \'Poppins\', sans-serif;color: black;">'+data[index].description+'<hr> </a></div></div><div><div></div><div></div></div>';
