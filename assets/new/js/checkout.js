                ...
                $.ajax({
                    ...
                    .done(function(data) {
                        ...
                        $.each(data, function(index) {
                            ...
                            htmlData+='<div class="wrap-input100 checkbox"><input checked type="checkbox" id="'+data[index].display+'" name="'+data[index].display+'" value="Bike"><label style="font-size: initial;" for="'+data[index].display+'">'+data[index].display+'</label><img src="'+data[index].imageUrl+'" alt="TEKLRN" width="250" height="100"><div><div style="float: left;"><button style="background: black; border-radius: 5px;height: 15px;"  type="button" id="email_"  class="login100-form-btn"><a style="font-size: x-small;">Edit<a></button></div><div style="float: left; margin-left: 3px;"><button style="background: #3a69bb; border-radius: 5px;height: 15px;"  type="button" id="email_e" onclick="removeAdd(\''+data[index].display+'\')"   class="login100-form-btn"><a style="font-size: x-small;">Remove<a> </button></div></div></div>'
