...
for (var i = 1; i <= b.total_levels; i++) { 
    ...
    function lvlclk(url, heading, technology){ 
        ...
        return false;   */
        window.open(window.location.origin+"/trendingnews/technology/read?url="+url+'&heading='+heading+'&description='+technology, "_self");     
     }
