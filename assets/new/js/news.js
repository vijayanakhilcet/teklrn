  ...
  .done(function (data) {
   ...
   var test_html_message_mgc3 = ""
    ...
    $.each(data, function (index) {
       ...
       if (i%3==0){
          //li_el += '<li><span class="tree_label"><div class="col-md-6"><p id="ad-p-'+i+'" style="width: 80% !important;object-fit: cover !important; overflow-clip-margin: content-box; overflow: clip;"></p></div></span></li>';
