...
getNewsContent();
 ...
 function getNewsContent(){
   ...
   .complete(function(data) {
      var adsVal = document.getElementById("ads").innerHTML

      try { 
         document.getElementById("forAd4").innerHTML = adsVal;
         document.getElementById("forAd8").innerHTML = adsVal;
         document.getElementById("forAd12").innerHTML = adsVal;
         document.getElementById("forAd16").innerHTML = adsVal;
         document.getElementById("forAd20").innerHTML = adsVal;
      }
      catch(err) {
         try { 
            document.getElementById("forAd4").innerHTML = adsVal;
