    ...
    function refineSearchView(pg){
        ...
        $.ajax({
            ...
            .done(function(data) {
                elm.innerHTML="";  
                $.each(data, function(index) {
                      html_message +='<div onclick="gotoTechnology(\''+data[index].description+'\')" ><img style="float: left;width: 200px; height: 135px;object-fit: cover;"  /></div>'
                    });
