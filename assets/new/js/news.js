   ...
   var test_html_message=""
    ...
    $.each(data, function (index) {
       ...
       if (i%3==0){
          ...
          test_html_message +='<div style="position:relative;" ><p id="ad-pp-'+i+'" style="padding-left:2%;font-size:small;position:absolute; color:white;font-weight:600;bottom: 2px; text-transform: uppercase;border-bottom: 1mm ridge #1c8ccd;z-index:31222; width:100%; text-overflow: clip; overflow: hidden; "></p></div>';
