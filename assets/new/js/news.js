 ...
 function getNewsContent(){
  ...
  .done(function (data) {
   var test_html_message=""
    ...
    $.each(data, function (index) {
       i=i+1;
       test_html_message +='<div style="position:relative;" onclick="gotoTechnology1(\''+data[index].newtitle+'\',\''+data[index].newtitle+'\',\''+'RelatedNws'+i+'---'+data[index].newtitle+'\')" ><img onerror="this.src=\'/static/image/test/certificate.jpg\'"   id="RelatedNws'+i+'---'+data[index].newtitle+'Test'+'" style="float: left;width: 200px; height:75px;object-fit: cover;" src="'+data[index].newtitle+'" /><p  style="padding-left:2%;font-size:small;position:absolute; color:white;font-weight:600;bottom: 2px; text-transform: uppercase;border-bottom: 1mm ridge #1c8ccd;z-index:31222; width:100%; text-overflow: clip; overflow: hidden; ">'+data[index].newtitle+'</p></div>';
       ...
       if (i%3==0){
          ...
          test_html_message +='<div style=""><p id="ad-pp-'+i+'" style="padding-left:2%;font-size:small;position:absolute; color:white;font-weight:600;bottom: 2px; text-transform: uppercase;border-bottom: 1mm ridge #1c8ccd;z-index:31222; width:100%; text-overflow: clip; overflow: hidden; "></p></div>';
