...
function sideMenu(){
    ...
    '<li><a style="background:white;" href="#trainerbookCrse" data-toggle="collapse"  class="dropdown-toggle">Book</a><ul style="padding-left:10%; background:#fafafa;" class="collapse list-unstyled" id="trainerbookCrse"></ul></li>'+
    '<li><a style="background:white;" href="#trainerSched" data-toggle="collapse"  class="dropdown-toggle">Scheduled</a><ul style="padding-left:10%; background:#fafafa;" class="collapse list-unstyled" id="trainerSched"></ul></li>'+
    '<li><a style="background:white;" href="#trainerCompl" data-toggle="collapse"  class="dropdown-toggle">Completed</a><ul style="padding-left:10%; background:#fafafa;" class="collapse list-unstyled" id="trainerCompl"></ul></li>'+
...
function getAcceptedStudentTrainings(){              
    $.ajax({
        ...
        encode      : true
         ...
         $.each(data, function(index) {
            var li_element = document.createElement('li'); // create the option element
            var aHtml = '<a style="background: white; padding-left:10%;" href="#">'+data[index].date+'<button style="font-size: x-small; border: 1px solid transparent;background-color:  #075aa3; vertical-align: middle;font-size: x-small;color: white;border-radius: .25rem;" type="Submit" value="'+ data[index].pk + '" onclick="lvlclk1(\''+data[index].course+'_'+ data[index].level+'\')">Syllabus'+data[index].course+' Level     '+ data[index].level+ ' <i  style="vertical-align:middle;" class="fas fa-check"></i></button><button style="font-size: x-small; margin-left: .2rem;   border: 1px solid transparent;background-color:  #075aa3;;font-size: x-small;color: white;border-radius: .25rem;"  onclick="window.open('+'\''+data[index].meetingLink+'\''+')">Join  <i  style="vertical-align:middle;"  class="fas fa-video"></i></button></a>';
            li_element.innerHTML+=aHtml;            
            elm.appendChild(li_element); 
          });
});
    ...
    $.ajax({
        ...
        .done(function(data) {
         ...
         $.each(data, function(index) {
          ...
          + ' <button style="font-size: x-small; border: 1px solid transparent;background-color: #075aa3;font-size: x-small;color: white;border-radius: .25rem;" type="Submit" value="'+ data[index].pk + '" onclick="bookThis(event, '+data[index].pk+')">Book '+'<i  style="vertical-align:middle;" class="fas fa-chalkboard-teacher"></i></button></a>';
            li_element.innerHTML+=aHtml;
            elm.appendChild(li_element); 
          });
