...
function videoClk1(event, crse, lvl, description, videolink, levels_total){ 
    ...
    var iframe = '<video id="my_video" data-setup="{}" class="video-js" poster="static/image/images/poster.jpg" autoplay playsinline id="frameclk" controls controlsList="nodownload"  height="100%" width="100%"><source src="'+parseVideoLink(videolink)+'" type="video/mp4"></video>';
    $.createModalVid({
      message: iframe,
      closeButton:true,
      scrollable:false,
