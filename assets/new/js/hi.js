...
function parseVideoLink(linkVid){        
    ...
    var newStr = 'https://drive.google.com/uc?id='+tmpStr[1];
    return newStr;
}
...
function videoClk1(event, crse, lvl, description, videolink, levels_total){ 
    ...
    var iframe = '<video poster="static/image/images/poster.jpg"   id="frameclk" controls controlsList="nodownload"  height="100%" width="100%"><source src="'+parseVideoLink(videolink)+'" type="video/mp4"></video>';
    $.createModalVid({
      message: iframe,
      closeButton:true,
      scrollable:false,
