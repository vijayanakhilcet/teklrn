                ...
                try:
                    ...
                    for all_p in soup.find_all('p')[1:-1]:
                        if len(all_p.text.strip().split())>=10:
                            i=i+1
                            if i==4:          
                                pElement = pElement+'<p style="margin: 0px !important;pointer-events: all !important;" id="forAd4"></p>'
                            if i==8:          
                                pElement = pElement+'<p style="margin: 0px !important;pointer-events: all !important;" id="forAd8"></p>'
                            if i==12:          
                                pElement = pElement+'<p style="margin: 0px !important;pointer-events: all !important;" id="forAd12"></p>'
                            if i==16:          
                                pElement = pElement+'<p style="margin: 0px !important;pointer-events: all !important;" id="forAd16"></p>'
                            if i==20:          
                                pElement = pElement+'<p style="margin: 0px !important;pointer-events: all !important;" id="forAd20"></p>'
