                ...
                try:
                    ...
                    for all_p in soup.find_all('p')[1:-1]:
                        if len(all_p.text.strip().split())>=10:
                            i=i+1
                            # if i==3:          
                            #     pElement = pElement+'<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-3671375601838095" crossorigin="anonymous"></script><ins class="adsbygoogle" style="display:block; text-align:center;" data-ad-layout="in-article"   data-ad-format="fluid"  data-ad-client="ca-pub-3671375601838095"  data-ad-slot="7874188453"></ins><script>     (adsbygoogle = window.adsbygoogle || []).push({});</script>'
                            ...
                            pElement = pElement+ '<p id= '+'"'+i+'"'+'style="color:black;">'+all_p.text.strip()+'</p>'
                    if len(pElement.split())>=200:
                        course_json = {}
